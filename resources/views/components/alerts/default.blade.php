...
<div class="relative w-full overflow-hidden mb-2" role="alert">
    <div class="flex w-full items-center gap-2 bg-gray-500/10 p-4 border border-gray-400 rounded-sm">
        <div class="bg-gray-500/15 text-gray-700 rounded-full p-1" aria-hidden="true">
