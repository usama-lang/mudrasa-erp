<x-layouts.backend-layout :breadcrumbs="$breadcrumbs">
    ...
    <x-card class="mb-6 no-print">
        <x-slot name="title">{{ bi('Department Summary') }}</x-slot>
        <form method="GET" action="{{ route('school.fees.reports.department') }}" class="flex items-end gap-3 flex-wrap">
            <div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left">
                ...
                <tbody>
                    ...
                    <tr wire:key="dept-{{ $i }}" class="border-b border-gray-100 dark:border-gray-700">
