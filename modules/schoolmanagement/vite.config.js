...
const distOutDir = path.resolve(__dirname, 'dist/build-schoolmanagement');
const devOutDir = path.resolve(__dirname, '../../public/build-schoolmanagement');
...
export default defineConfig({
    ...
    plugins: [
        laravel({
            ...
            buildDirectory: 'build-schoolmanagement',
            input: [
