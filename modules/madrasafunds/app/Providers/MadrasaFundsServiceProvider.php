...
namespace Modules\MadrasaFunds\Providers;

use Illuminate\Support\Facades\Blade;
use Illuminate\Support\ServiceProvider;
use Modules\MadrasaFunds\Services\ModuleService;
use Nwidart\Modules\Traits\PathNamespace;
use RecursiveDirectoryIterator;
use RecursiveIteratorIterator;

class MadrasaFundsServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'MadrasaFunds';

    protected string $nameLower = 'madrasafunds';
